...
const getBook = async (req, res, next) => {
    ...
    //Esto "/^[0-9a-fA]-F]{24}$/" es el tipico id de mongo
...
//Obtiene solo un libro, por medio del id
router.get('/:id', getBook, async(req, res) => {
    res.json(res.book);
})

//Actualiza el libro, por medio del id
...
//Actualiza algun campo del libro que escogemos por medio del id
...
//Elimina el libro por medio del id
